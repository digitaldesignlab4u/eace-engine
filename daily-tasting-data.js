...
const waveBridgeLines = [
  "If your system reaches EU users or EU-market outputs, EU rules can apply, wherever your company is based.",
  "The military and national-security exclusion is narrow: write down the exclusive purpose before assuming it applies.",
  "Research and pre-market testing are shielded. Real-world testing on real people generally is not.",
  "A personal hobby project stops being exempt the moment it becomes a work tool.",
  "Persuasive design only crosses this line when it truly bends someone's choice and causes real harm. Prove the whole chain, do not assume it.",
  "Targeting someone's age, disability or hardship to steer their behaviour is the trigger here, not vulnerability alone.",
  "Watch what happens to a score once it leaves its original context. That is where this prohibition bites.",
  "Predicting who will offend from profiling alone is off the table. Supporting a human's fact-based judgment is a different story.",
  "If your facial-recognition data ever came from scraping the open web or CCTV without consent, that is the line this rule draws.",
  "Reading emotions at work or in school is banned by default. Only a genuine, narrow safety or medical case gets you out.",
  "If your biometric system quietly infers race, beliefs or orientation, that inference itself is the regulated act.",
  "Live facial-recognition scanning of public spaces starts from no. Every exception has to be argued and authorised, not assumed.",
  "Non-consensual intimate deepfakes are prohibited regardless of how convincing the disclaimer is.",
  "This is a zero-tolerance line: capability limits, safeguards and escalation paths all have to be airtight, not aspirational.",
  "Being on the Annex III list is not always the final word. Check whether a genuine exception actually fits before you conclude high-risk.",
  "Ask whether the AI is actually a safety component, not just software that happens to sit near critical infrastructure.",
  "Not every EdTech feature is high-risk. Map it to the exact function: admission, scoring, or monitoring.",
  "One HR platform can hold several different obligations. Classify each hiring or monitoring feature on its own.",
  "If the system decides who gets credit, insurance or public assistance, treat that decision path as high-risk.",
  "Check Article 5 first. Some law-enforcement uses are banned outright before you even get to classify them.",
  "Not every border tool is automatically high-risk. Find its exact listed function before labelling it.",
  "Helping judges research the law and swaying an election are two very different obligations. Do not blend them.",
  "If a person could reasonably think they are talking to a human, tell them upfront that they are not.",
  "AI-generated images, audio, video or text need a machine-readable mark. Check the exceptions before assuming yours is exempt.",
  "People exposed to emotion-recognition or biometric categorisation need to know before it happens, not after.",
  "A deepfake and an AI-written news article trigger two separate disclosure duties. Handle them as different obligations.",
  "Not high-risk is not the same as unregulated. Run the leftover obligations check anyway.",
  "Fun and low-stakes does not mean rule-free. Re-check the feature the moment its purpose changes.",
  "Voluntary commitments are a good look, but never let them be marketed as if they were mandatory law.",
  "Watching your system after launch is not optional paperwork. Build the plan before you need it.",
  "The clock on a serious incident starts at awareness, not at your convenience. Track that timestamp precisely.",
  "Some incidents are severe enough that two days is the outer limit. Pre-decide what counts as severe before it happens.",
  "A death-related incident needs immediate escalation the moment a causal link is even suspected.",
  "Know which authority to call and what evidence to hand over before an inspector asks.",
  "Fines differ by actor and infringement. Map each obligation to its own ceiling, not one flat number.",
  "The 2026 amendment touched more than dates. Re-check definitions, prohibitions and timing article by article.",
  "General-purpose model or not, documentation, downstream information and a copyright policy are the baseline, not extras.",
  "Crossing the compute threshold creates a presumption, not a verdict. Capability and Commission designation matter too.",
  "If you expect to meet the systemic-risk threshold, tell the Commission without delay. Do not wait for certainty.",
  "Red-teaming a systemic-risk model is not a one-off exercise. It needs to be documented, repeatable evidence.",
  "A model built outside the EU still usually needs a real, contactable EU representative before it reaches the market.",
  "Not all software is an AI system under the Act. Test the statutory elements before you apply any of these rules.",
  "Whoever's name is on the system usually carries the provider's obligations. Know who that actually is.",
  "Buying an AI tool and deploying it are different roles. Using it under your authority makes you the deployer.",
  "Bringing in a system under someone else's brand from outside the EU makes you the importer, with importer duties.",
  "Even without touching the product, making it available on the market can make you a distributor with real duties.",
  "Embed AI in a regulated product under your own name, and you may inherit the provider's obligations along with it.",
  "Rebrand or substantially modify someone else's high-risk system, and the provider role can quietly become yours.",
  "Keep your marketing, instructions and actual design saying the same thing about what the system is for.",
  "Do not hide behind that is not what it is for. Foreseeable misuse is still your responsibility to anticipate.",
  "Sitting inside a regulated product is not enough on its own. Ask whether the AI performs an actual safety function.",
  "The product-safety route needs both conditions met, the linked legislation and third-party assessment, not just one.",
  "The use-case route is about intended purpose. Match the feature to its exact Annex III category.",
  "An Annex III listing can still be excepted for narrow, low-risk tasks, but profiling always stays high-risk.",
  "Concluding not high-risk is not the end. Write the assessment down and register it where required.",
  "Risk management here is not a one-time document. It has to keep running for as long as the system does.",
  "Good data is not just about accuracy. Know where it came from, what it represents, and where the bias sits.",
  "Processing sensitive data to fix bias needs a real, documented, strictly necessary justification, not a blanket excuse.",
  "Build the technical file as you go, not the week before someone asks to see it.",
  "If something goes wrong, you need a record of what the system actually did. Design that in from the start.",
  "Instructions should tell a deployer what the system cannot do, not just what it can.",
  "Oversight has to match the system's real autonomy and risk, not be a token human standing nearby.",
  "Set numbers for accuracy and robustness, then actually watch for drift over the system's life. Do not just measure it once.",
  "Provider duties come as a bundle. Treat them as one owned control matrix, not scattered to-dos.",
  "A quality management system only works if it actually connects your policies, testing, suppliers and incidents, not if each lives in its own silo.",
  "Ten years is a long time to keep evidence retrievable. Decide who owns that now, not later.",
  "Only keep logs you actually control, and make sure they still mean something years from now.",
  "The moment you have reason to doubt conformity, the corrective-action clock starts. Waiting for certainty is not an option.",
  "When a regulator asks, you should be able to answer fast. Build that response pack before you need it.",
  "A third-country provider needs a real EU representative with real authority, not a mailbox.",
  "Importers have to check the paperwork before the system reaches the market, not trust the label.",
  "If the conformity signals look wrong, a distributor's job is to stop, not to pass it along.",
  "When roles shift along the supply chain, the contract should already say who owes what information to whom.",
  "Buying a compliant system does not make your use of it compliant. Deployers carry their own separate duties.",
  "The instructions for use are meant to be followed, not filed away. Turn them into real procedures and training.",
  "The person overseeing the system needs real training and real authority to act, not just a job title.",
  "If you control the input data, its quality and representativeness become your problem too.",
  "Set a clear threshold for when to pause or escalate. Do not wait to notice something is wrong by accident.",
  "Six months of logs is the floor, not the ceiling. Check whether stricter sector rules push that higher.",
  "Tell workers and their representatives before the system goes live at work, not after it is already running.",
  "Use the provider's information to help your data-protection impact assessment, but do not treat one assessment as a substitute for the other.",
  "If a decision about someone rests on this system, tell them plainly, not in a footnote.",
  "Check whether you are the kind of deployer this applies to before assuming a fundamental-rights impact assessment is, or is not, required.",
  "Not every high-risk system takes the same conformity route. Confirm which one applies before scheduling assessment work.",
  "A certificate is not permanent. Track its scope and expiry like any other piece of controlled evidence.",
  "Only write the declaration of conformity once the underlying evidence is actually finished.",
  "CE marking is not a branding choice. It has to reflect a completed conformity route underneath it.",
  "If registration is required, treat it as a release gate, not an afterthought.",
  "A harmonised standard only helps you where it actually covers the requirement. Map the two carefully.",
  "Do not build compliance around a common specification that does not exist yet. Wait for the Commission to adopt it.",
  "If you are claiming a testing-based presumption, keep the evidence for exactly which one and why.",
  "Before trusting a certificate, check that the notified body was actually designated to assess this kind of system.",
  "A change to the model, data, feature or purpose that was not foreseen at assessment time can restart your compliance clock.",
  "Systems that keep learning after launch can stay covered, but only for the changes you specified in advance.",
  "A regulatory sandbox is supervised testing under an agreed plan, not a compliance-free zone.",
  "Do not call a live pilot just research. Real-world testing has its own conditions and safeguards.",
  "If vulnerable people are part of your test, their protection and ability to withdraw need extra care.",
  "Support measures ease the path for smaller companies. They do not lower the bar itself.",
  "Literacy measures should fit who is actually using the system, not be a single generic training for everyone.",
  "Fixing bias with sensitive data needs a documented, strictly necessary case. It is not a general licence to use it.",
  "Open-source does not mean exempt. Prohibitions, transparency and systemic-risk rules can still apply.",
  "If you are building on someone else's model, get the technical information you need to classify and document your own system.",
  "A copyright policy needs to actually track and honour rights reservations, not just exist as a document.",
  "The training-data summary is only credible if it comes from data governance you can actually trace.",
  "Systemic risk means thinking beyond your own product. Look at how it could propagate across the whole value chain.",
  "Model-level incidents need their own reporting channel, separate from a deployed system's incident process.",
  "Model security, infrastructure security and systemic-risk scenarios should be one conversation, not three separate ones.",
  "A code of practice can help show compliance, but it does not replace the underlying legal obligation.",
  "A compliant purchase does not guarantee a compliant deployment. Build deployer obligations into the procurement criteria itself.",
  "An overseer who cannot actually understand or stop the system is not oversight. It is decoration.",
  "Design the interface to make people question the AI's output sometimes, not just click accept.",
  "Test the stop mechanism under real failure conditions, not just in a clean demo.",
  "Scattered documents are not proof. Connect the dots from requirement to control to evidence to a named owner.",
  "Know your deployer category first. That decides whether the fundamental-rights impact assessment duty even reaches you.",
  "A fundamental-rights impact assessment and a data-protection impact assessment can share evidence, but they are still answering two different legal questions.",
  "Only claim what your actual evidence covers. AI Act compliant is not a universal badge.",
  "Different provisions now have different start dates. Keep one matrix, not one deadline in your head.",
  "If your product could touch the new December 2026 prohibitions, put that readiness work on its own track now.",
  "Build the evidence first, then make the claim, never the other way around.",
  "Before reaching for a checklist, work out what the system actually is and which role you hold in it."
];
