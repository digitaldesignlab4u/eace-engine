 ...
 *   michelinMenu[i]      → { title, meta, elba, kai, action }
 *   waveBridgeLines[i]   → plain-language "what this means for you" string
 *
 * RULE: Wave never shares a card with Elba and Kai — it renders only on
...
const michelinMenu = [
  ...
  // ============ LEVEL 1 — TERRITORIAL SCOPE (4) ============
  {
    ...
    elba: "My maître d' does not ask where you flew in from. He asks one question: does the dish land on a table inside this house? If your output reaches a guest in the Union, you follow house rules the moment it crosses the threshold.",
  ...
  },
  {
    ...
    elba: "Some kitchens answer to a different authority entirely. Military service is not on my menu, and I don't pretend to inspect it.",
  ...
  },
  {
    ...
    elba: "A test kitchen that never serves a paying guest doesn't need a health inspection — but the day you plate it for someone real, the exemption ends at the door.",
  ...
  },
  {
    ...
    elba: "What you cook for yourself at home is your own business. Nobody's inspecting a family dinner.",
  ...
  // ============ LEVEL 2 — PROHIBITED PRACTICES (9) ============
  {
    ...
    elba: "If a system secretly manipulates a guest through subliminal technique, that isn't cuisine — it's poisoning the table and calling it a tasting menu.",
  ...
  },
  {
    ...
    elba: "Exploiting a hungry guest's desperation isn't hospitality — it's the oldest trick in a bad kitchen's book.",
  ...
  },
  {
    ...
    elba: "A restaurant that blacklists you for something you did in a different city, in a different context, has stopped serving food and started keeping a ledger of sins.",
  ...
  },
  {
    ...
    elba: "Judging someone for a crime they haven't committed, based on nothing but their profile, is a dish this kitchen refuses to plate. Ever.",
  ...
  },
  {
    ...
    elba: "Harvesting a guest's likeness without them ever walking through the door isn't sourcing ingredients. It's theft with a search engine.",
  ...
  },
  {
    ...
    elba: "A chef who reads a diner's face to sell them dessert is charming. A chef who reads an employee's face to decide who gets fired is something else entirely.",
  ...
  },
  {
    ...
    elba: "What a guest believes, worships, or votes for is not an ingredient I'm permitted to taste for.",
  ...
  },
  {
    ...
    elba: "A street under permanent, silent surveillance is not a dining room. It's an interrogation, and this kitchen won't run one without a warrant-grade reason.",
  ...
  },
  {
    ...
    elba: "Serving a guest a face that was never given to us, in a way they never agreed to, is the single worst thing that can leave this kitchen. There is no recipe that makes that acceptable, and as of this winter, there is no legal grey area left either.",
  ...
  // ============ LEVEL 3 — HIGH-RISK SYSTEMS (8) ============
  {
    ...
    elba: "Biometric identification is a soufflé under pressure. One structural error and the whole thing collapses in front of the inspector.",
  ...
  },
  {
    ...
    elba: "A kitchen with no water pressure and no gas line doesn't serve dinner. It serves an incident report.",
  ...
  },
  {
    ...
    elba: "Deciding who gets a seat at the table, and who is quietly turned away, is the single most consequential decision a host can make.",
  ...
  },
  {
    ...
    elba: "Deciding who gets hired, promoted, or let go on the strength of an algorithm's judgment is a decision made in someone's kitchen, about someone's livelihood.",
  ...
  },
  {
    ...
    elba: "Telling a guest they can't afford the meal, based on a model they've never seen, is a decision that deserves the same scrutiny as the meal itself.",
  ...
  },
  {
    ...
    elba: "A kitchen that decides guilt before the trial has stopped cooking and started sentencing.",
  ...
  },
  {
    ...
    elba: "Deciding who is welcome and who is turned away at the door is a decision no kitchen takes lightly — least of all one where the stakes are someone's safety.",
  ...
  },
  {
    ...
    elba: "Helping the judge read faster is one thing. Helping the judge decide is another — and this kitchen only serves the first course.",
  ...
  // ============ LEVEL 4 — TRANSPARENCY (4) ============
  {
    ...
    elba: "If the voice on the other end is not human, say so before the first exchange — not buried in a footnote.",
  ...
  },
  {
    ...
    elba: "A dish built entirely from synthetic ingredients should say so on the menu — not dressed up to look like something it isn't.",
  ...
  },
  {
    ...
    elba: "If I'm reading a guest's face to understand them, they deserve to know I'm looking.",
  ...
  },
  {
    ...
    elba: "A guest reading tonight's news deserves to know whether it was written by a person or a machine wearing a person's byline.",
  ...
  // ============ LEVEL 5 — MINIMAL RISK (3) ============
  {
    ...
    elba: "Not every ingredient needs a certificate of provenance pinned to it. Most of what leaves the pass is simply competent cooking.",
  ...
  },
  {
    ...
    elba: "A game is a game. Nobody needs a risk-management system to enjoy dessert.",
  ...
  },
  {
    ...
    elba: "Not every kitchen needs an inspector to cook honestly. Some hold themselves to the standard anyway, because it's good practice, not because someone is watching.",
  ...
  // ============ LEVEL 6 — GOVERNANCE, MONITORING, ENFORCEMENT (7) ============
  {
    ...
    elba: "A kitchen doesn't stop tasting once the dish leaves the pass. You keep tasting, every service, for as long as the dish is on the menu.",
  ...
  },
  {
    ...
    elba: "When something breaks in service, you don't wait for the perfect explanation before telling the front of house. You say what you know, when you know it.",
  ...
  },
  {
    ...
    elba: "Some fires you call in immediately, before you've even found the extinguisher.",
  ...
  },
  {
    ...
    elba: "Some things you never wait on. You report the moment the link is established, and the deadline exists only as a hard outer limit, not a target.",
  ...
  },
  {
    ...
    elba: "Every serious kitchen keeps a logbook the inspector can seize without warning. A spotless dining room means nothing if the log behind the pass is empty.",
  ...
  },
  {
    ...
    elba: "Every kitchen eventually gets the bill for how it was run. Some bills are survivable. Some end the restaurant.",
  ...
  },
  {
    ...
    elba: "Even the finest kitchen occasionally rewrites its own menu mid-season. The standard didn't lower. The service date moved.",
  ...
  // ============ LEVEL 7 — GPAI OBLIGATIONS (5) ============
  {
    ...
    elba: "A proper consommé is perfectly clear. You see straight to the bottom of the bowl. Show your ingredients, or leave the kitchen.",
  ...
  },
  {
    ...
    elba: "Some kitchens serve a neighbourhood. Some serve a nation. The bigger the kitchen, the heavier the obligation — and you don't get to decide which one you're running.",
  ...
  },
  {
    ...
    elba: "The moment you know your kitchen has grown too large to serve quietly, you tell the authority — you don't wait for them to notice first.",
  ...
  },
  {
    ...
    elba: "A kitchen this size doesn't just cook the dish. It tries to break it first, deliberately, before anyone else can.",
  ...
  },
  {
    ...
    elba: "If you're going to serve this dining room from a kitchen abroad, someone local has to be able to answer the door when the inspector knocks.",
